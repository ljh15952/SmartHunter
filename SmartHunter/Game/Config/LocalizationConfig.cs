...
namespace SmartHunter.Config
{
    public class LocalizationConfig
    {
        ...
        public Dictionary<string, string> Strings = new Dictionary<string, string>()
        {
            ...
            // SettingsView
            { "LOC_SETTING_USE_SERVER", "Use Server"},
            { "LOC_SETTING_USE_SERVER_DESC", "By enabling this option you'll be able to receive Monster Parts and Statuses even if you are not current host and to receive other party members damages in expeditions.\nPlease note that this will work only if also other members have this option on. There is a great PDF explaining how that work on my repo, so be sure to check it out"},
            { "LOC_SETTING_RESTART", "Restart"},
            ...
            { "LOC_SETTING_HIDE_WHEN_GAME_WINDOW_IS_INACTIVE_DESC", "Automatically hide every SmartHunter window when MonsterHunterWorld it not top most application"},
            { "LOC_SETTING_TEAM_WIDGET", "Team Widget"},
            { "LOC_SETTING_TEAM_WIDGET_DESC", "Show/Hide Team Widget"},
            { "LOC_SETTING_DONT_SHOW_IF_ALONE", "Don't show if alone"},
            { "LOC_SETTING_DONT_SHOW_IF_ALONE_DESC", "Automatically hide Team Widget if you are alone in a mission"},
            { "LOC_SETTING_TEAM_WIDGET_SHOW_BARS", "Team Widget show bars"},
            { "LOC_SETTING_TEAM_WIDGET_SHOW_BARS_DESC", "Show Bars inside Team Widget"},
            { "LOC_SETTING_TEAM_WIDGET_SHOW_NUMBERS", "Team Widget show numbers"},
            ...
            { "LOC_SETTING_SHOW_UNCHANGED_MONSTERS_DESC", "Automatically hide monsters if they are not damaged"},
            { "LOC_SETTING_SHOW_PARTS", "Show Monster parts"},
            { "LOC_SETTING_SHOW_PARTS_DESC", "Show/Hide Monsters parts"},
            { "LOC_SETTING_SHOW_UNCHANGED_PARTS", "Show unchanged parts"},
            { "LOC_SETTING_SHOW_UNCHANGED_PARTS_DESC", "Automatically hide monsters parts if they are not damaged"},
            { "LOC_SETTING_SHOW_STATUS_EFFECT", "Show Monster status effects"},
            { "LOC_SETTING_SHOW_STATUS_EFFECT_DESC", "Show/Hide Monsters status effects"},
            ...
            { "LOC_SETTING_SHOW_MONSTER_CROWN_DESC", "Show monster crown image"},
            { "LOC_SETTING_MONSTER_WIDGET_SHOW_BARS", "Monster Widget show bars"},
            { "LOC_SETTING_MONSTER_WIDGET_SHOW_BARS_DESC", "Show Bars inside Monster Widget"},
            { "LOC_SETTING_MONSTER_WIDGET_SHOW_NUMBERS", "Monster Widget show numbers"},
            { "LOC_SETTING_MONSTER_WIDGET_SHOW_NUMBERS_DESC", "Show Numbers inside Monster Widget"},
            { "LOC_SETTING_MONSTER_WIDGET_SHOW_PERCENTS", "Monster Widget show percents"},
            { "LOC_SETTING_MONSTER_WIDGET_SHOW_PERCENTS_DESC", "Show Percents inside Monster Widget"},
            { "LOC_SETTING_USE_ANIMATIONS", "Use animations"},
            { "LOC_SETTING_USE_ANIMATIONS_DESC", "Enable/Disable Animations for status effects"},
            { "LOC_SETTING_SHOW_ONLY_SELECTED_MONSTER", "Show only selected monster"},
            { "LOC_SETTING_SHOW_ONLY_SELECTED_MONSTER_DESC", "Show only the monster that you selected for your hunt"},
            { "LOC_SETTING_ALWAYS_SHOW_PARTS", "Always show parts"},
            { "LOC_SETTING_ALWAYS_SHOW_PARTS_DESC", "Always show Monsters parts"},
            { "LOC_SETTING_PLAYER_WIDGET", "Player Widget"},
            { "LOC_SETTING_PLAYER_WIDGET_DESC", "Show/Hide Player Widget"},
